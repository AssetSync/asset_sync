...
* **webpacker_assets**: (`true, false`) when enabled, will use the `manifest.json` generated by Rails/webpacker to append the webpacker assets to list of local files to upload. **experimental**. **default:** `'false'`
